    ...
    function fetch(smth,listNum) {
            ...
            for (var i=0; i<=4; i++){
              ...
              $(".answer", thisCategory).eq(i).html(smth.results[i].correct_answer);
                ...
                var correct = $('<br><br><button type="button" class="btn btn-info btn-lg btn-block correct" id="correct">' + smth.results[i].correct_answer + '</button>');
                var inc1 = $('<br><br><button type="button" class="btn btn-info btn-lg btn-block incorrect" id="inc1">' + smth.results[i].incorrect_answers[0]+ '</button>');
                var inc2 = $('<br><br><button type="button" class="btn btn-info btn-lg btn-block incorrect" id="inc2">' + smth.results[i].incorrect_answers[1]+ '</button>');
                var inc3 = $('<br><br><button type="button" class="btn btn-info btn-lg btn-block incorrect" id="inc3">' + smth.results[i].incorrect_answers[2]+ '</button>');
